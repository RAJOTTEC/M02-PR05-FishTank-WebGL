...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                Vector3 randomPos = new Vector3(Random.Range(2f, mapWidth - 2), Random.Range(2f, mapWidth - 2), Random.Range(2f, mapWidth - 2));
            ...
            Vector3 randomEnemyPos = new Vector3(Random.Range(2f, mapWidth - 2), Random.Range(2f, mapWidth - 2), Random.Range(2f, mapWidth - 2));

            GameObject newEnemy = Instantiate(enemyObj, randomEnemyPos, Quaternion.identity) as GameObject;
